...
add_filter( 'the_content', function( $content ) {
	...
	/* TRUST */
	.cs-trust { background: #EBF1FA; text-align: center; }
	.cs-trust-badges {
		display: flex;
		flex-wrap: wrap;
		justify-content: center;
	...
	.cs-trust-badge { min-width: 160px; }
	.cs-trust-badge .label {
		display: block;
		color: #0B3D91;
		font-size: 13px;
		font-weight: 700;
	...
	@media (max-width: 900px) {
		...
		.cs-trust-badges { gap: 18px; }
		.cs-trust-badge { min-width: 130px; }
	}
	...
	<div class="caspian-stove-page">
		...
		<section class="cs-hero">
			<h1>Stove &amp; Cooktop Repair in Hamilton — Same-Day Service</h1>
		...
		<section class="cs-section cs-intro">
			<div class="cs-inner">
				...
				<p class="cs-section-lead">Caspian Appliance Repair has been a trusted name in the appliance repair industry since 2009. Cooktop and stove repairs require the right expertise depending on the heat source — we have both teams.</p>
		...
		<section class="cs-section cs-gas-section">
			<div class="cs-inner">
				...
				<div class="cs-tssa-notice">
					<p><strong>Important:</strong> Gas appliance repairs performed by certified TSSA-licensed partner technicians, in compliance with Ontario regulations. Every repair includes proper leak testing — your safety is non-negotiable.</p>
				</div>
		...
		<section class="cs-section cs-brands">
			<div class="cs-inner">
				...
				<div class="cs-brand-grid">
					<div class="cs-brand">Samsung</div>
					<div class="cs-brand">LG</div>
					<div class="cs-brand">Whirlpool</div>
					<div class="cs-brand">KitchenAid</div>
					<div class="cs-brand">Bosch</div>
					<div class="cs-brand">Maytag</div>
					<div class="cs-brand">Frigidaire</div>
					<div class="cs-brand">GE</div>
				</div>
			</div>
		</section>

		<!-- ============ TRUST ============ -->
		<section class="cs-section cs-trust">
			<div class="cs-inner">
				...
				<p class="cs-disclaimer">Caspian Appliance Repair is independent and not affiliated with any manufacturer. We are not factory-authorized for warranty work — we provide quality out-of-warranty repairs across Hamilton and 20+ Ontario cities.</p>
			</div>
		</section>
		...
		<section class="cs-section" style="background:#fff;">
			<div class="cs-inner">
				...
				<div class="cs-faq-list">
					...
					<div class="cs-faq-item">
						<div class="cs-faq-q">Is the repair warrantied? Do you offer same-day service?</div>
						<div class="cs-faq-a">Every Caspian repair comes with a 90-day parts and labour warranty. Same-day service is available in most cases — call us during business hours (7AM–11PM, 7 days a week) and our live agents will confirm the earliest available window.</div>
					</div>
		...
		<section class="cs-cta-final">
			<h3>Same-Day Stove &amp; Cooktop Repair</h3>
...
add_action( 'wp_head', function() {
	...
	$faqs = array(
		...
		array(
			'q' => 'Is the repair warrantied? Do you offer same-day service?',
			'a' => 'Every Caspian repair comes with a 90-day parts and labour warranty. Same-day service is available in most cases — call us during business hours (7AM-11PM, 7 days a week) and our live agents will confirm the earliest available window.',
		),
	);
