<?php
/**
 * Plugin Name: Caspian Brand - Electrolux Appliance Repair
 * Description: Renders /electrolux-appliance-repair/ page. Electrolux-specific content (Swedish mid-premium, Wave-Touch/IQ-Touch controls, Perfect Steam laundry, EI/EW models), factory-not-authorized disclosure, FAQ schema, etalon design (dark Why banner, gold-value stat cards, Service-note box).
 * Version: 1.0
 * Author: Caspian Build
 *
 * Same design/structure as the approved brand template; content is 100% Electrolux-unique.
...
add_filter( 'the_content', function( $content ) {
        if ( ! is_page( 'electrolux-appliance-repair' ) ) {
                return $content;
        }
        ...
        <div class="caspian-brand-page">
                ...
                <section class="cb-indep-banner">
                        <div class="cb-indep-banner-inner">
                                <p><strong>Important:</strong> Caspian Appliance Repair is an independent service provider, not affiliated with Electrolux. We are <strong>not factory-authorized for warranty work</strong> — we provide quality out-of-warranty repairs on Electrolux appliances. If your unit is still under manufacturer warranty, contact Electrolux directly to preserve coverage.</p>
                        </div>
                </section>
                ...
                <section class="cb-section">
                        <div class="cb-inner">
                                <h2>Electrolux Repairs — European Engineering, Local Service</h2>
                                <p class="cb-section-lead">Electrolux brings Swedish design to the mid-to-premium kitchen and laundry room — Perfect Steam front-load washers, Wave-Touch and IQ-Touch glass controls, and counter-depth French door refrigeration. That European engineering uses tighter tolerances and touch-control electronics that a general shop often mishandles. We diagnose Electrolux at the component level and quote the real fix before any work begins.</p>
                        </div>
                </section>
                ...
                <section class="cb-section" style="background:#EBF1FA;">
                        <div class="cb-inner">
                                <h2>Electrolux Appliances We Service</h2>
                                ...
                                <div class="cb-appliance-grid">
                                        <div class="cb-appliance-card">
                                                <h3>Refrigerators</h3>
                                                <a href="/refrigerator-repair/">Electrolux Fridge Repair &rarr;</a>
                                        </div>
                                        <div class="cb-appliance-card">
                                                <h3>Washing Machines</h3>
                                                <a href="/washing-machine-repair/">Electrolux Washer Repair &rarr;</a>
                                        </div>
                                        <div class="cb-appliance-card">
                                                <h3>Dryers</h3>
                                                <a href="/dryer-repair/">Electrolux Dryer Repair &rarr;</a>
                                        </div>
                                        <div class="cb-appliance-card">
                                                <h3>Dishwashers</h3>
                                                <a href="/dishwasher-repair/">Electrolux Dishwasher Repair &rarr;</a>
                                        </div>
                                        <div class="cb-appliance-card">
                                                <h3>Ovens &amp; Ranges</h3>
                                                <a href="/oven-repair/">Electrolux Oven Repair &rarr;</a>
                                        </div>
                                        <div class="cb-appliance-card">
                                                <h3>Cooktops</h3>
                                                <a href="/stove-cooktop-repair/">Electrolux Cooktop Repair &rarr;</a>
                                        </div>
                                </div>
                        </div>
                </section>
                ...
                <section class="cb-section" style="background:#fff;">
                        <div class="cb-inner">
                                <h2>Common Electrolux Issues We Diagnose Daily</h2>
                                <p class="cb-section-lead">More than 15 years of Electrolux repairs gives us pattern recognition. These three problems account for the majority of the Electrolux service calls we handle across the 30+ Ontario cities we serve.</p>
                                <div class="cb-issue-grid">
                                        <div class="cb-issue-card">
                                                <div class="cb-icon">&#128241;</div>
                                                <h3>Wave-Touch &amp; IQ-Touch Control Panels</h3>
                                                <p>Electrolux's signature glass touch controls become unresponsive, erratic, or partially dark over time. The fault is usually the touch panel itself or the control board behind it. We test both before replacing, so you don't pay for the wrong board.</p>
                                        </div>
                                        <div class="cb-issue-card">
                                                <div class="cb-icon">&#128167;</div>
                                                <h3>Drain Pump &amp; Water Inlet (Laundry &amp; Dishwashers)</h3>
                                                <p>Perfect Steam washers and Electrolux dishwashers that won't fill or drain usually trace to the water inlet valve, the drain pump, or a clogged filter. We confirm the exact part on-site rather than swapping the whole assembly.</p>
                                        </div>
                                        <div class="cb-issue-card">
                                                <div class="cb-icon">&#10052;</div>
                                                <h3>Counter-Depth Fridge Cooling</h3>
                                                <p>Electrolux French door and counter-depth fridges lose cooling at the evaporator fan, sealed system, or main control. These are premium units, so we pinpoint the failed component instead of guessing at an expensive sealed-system repair.</p>
                                        </div>
                                </div>
                        </div>
                </section>
                ...
                <section class="cb-section cb-models">
                        <div class="cb-inner">
                                <h2>Electrolux Model Lines We Service</h2>
                                <p class="cb-section-lead">We repair all current and most legacy Electrolux appliance lines. Below is a representative — not exhaustive — sample of models we routinely fix.</p>
                                <div class="cb-models-box">
                                        <h3>Refrigeration</h3>
                                        <ul>
                                                <li>EI23 / EI28 French door (counter-depth)</li>
                                                <li>EI23 Side-by-side</li>
                                                <li>EW23 built-in &amp; column</li>
                                        </ul>
                                        <h3 style="margin-top:18px;">Laundry</h3>
                                        <ul>
                                                <li>EFLS Perfect Steam front-load washers</li>
                                                <li>EFME Electric dryers</li>
                                                <li>EFMG Gas dryers (TSSA-licensed)</li>
                                        </ul>
                                        <h3 style="margin-top:18px;">Cooking &amp; Dishwashing</h3>
                                        <ul>
                                                <li>EW30 Electric ranges &amp; wall ovens (Wave-Touch)</li>
                                                <li>EW30 Gas ranges (TSSA-licensed)</li>
                                                <li>EI24 / EW24 dishwashers</li>
                                        </ul>
                                </div>
                        </div>
                </section>
                ...
                <section class="cb-section" style="background:#EBF1FA;">
                        <div class="cb-inner">
                                <h2>Electrolux Repair — Frequently Asked Questions</h2>
                                <div class="cb-faq-list">

                                        <div class="cb-faq-item">
                                                <div class="cb-faq-q">My Electrolux Wave-Touch panel is unresponsive — can you fix it?</div>
                                                <div class="cb-faq-a">Yes. An unresponsive or erratic glass touch panel is usually the touchpad itself or the control board behind it. We test both and replace only the failed part rather than swapping the whole console on a guess.</div>
                                        </div>

                                        <div class="cb-faq-item">
                                                <div class="cb-faq-q">My Electrolux washer won't drain or fill — what's wrong?</div>
                                                <div class="cb-faq-a">On Perfect Steam and other Electrolux washers, no-fill is usually the water inlet valve and no-drain is the drain pump or a clogged filter. We confirm the exact cause on-site before replacing any part.</div>
                                        </div>

                                        <div class="cb-faq-item">
                                                <div class="cb-faq-q">My Electrolux fridge isn't cooling — can you fix it?</div>
                                                <div class="cb-faq-a">Yes. Electrolux French door and counter-depth fridges usually lose cooling at the evaporator fan, sealed system, or main control. We diagnose the exact part so you don't pay for an unnecessary sealed-system repair.</div>
                                        </div>

                                        <div class="cb-faq-item">
                                                <div class="cb-faq-q">Do you service Electrolux Perfect Steam laundry?</div>
                                                <div class="cb-faq-a">Yes — we repair Perfect Steam front-load washers (EFLS) and matching dryers (EFME/EFMG), including steam-valve, door-lock, and control faults that many shops aren't equipped to handle.</div>
                                        </div>

                                        <div class="cb-faq-item">
                                                <div class="cb-faq-q">Does my Electrolux repair preserve the manufacturer warranty?</div>
                                                <div class="cb-faq-a">If your Electrolux is still under warranty, contact Electrolux or an authorized centre first to preserve coverage. We are not factory-authorized — we handle out-of-warranty repairs and will tell you honestly if your unit appears to still be covered.</div>
                                        </div>

                                        <div class="cb-faq-item">
                                                <div class="cb-faq-q">Are Electrolux parts easy to source in Ontario?</div>
                                                <div class="cb-faq-a">Most Electrolux parts arrive through Canadian distributors within 1–3 days. Some touch-control panels and specialty components can take longer — we give you a clear timeline and never start work without your approval.</div>
                                        </div>
...
add_action( 'wp_head', function() {
        ...
        $faqs = array(
                array(
                        'q' => "My Electrolux Wave-Touch panel is unresponsive — can you fix it?",
                        'a' => 'Yes. An unresponsive or erratic glass touch panel is usually the touchpad itself or the control board behind it. We test both and replace only the failed part rather than swapping the whole console on a guess.',
                ),
                array(
                        'q' => "My Electrolux washer won't drain or fill — what's wrong?",
                ...
                array(
                        ...
                        'a' => 'If your Electrolux is still under warranty, contact Electrolux or an authorized centre first to preserve coverage. We are not factory-authorized — we handle out-of-warranty repairs and will tell you honestly if your unit appears to still be covered.',
                ),
                array(
                        'q' => 'Are Electrolux parts easy to source in Ontario?',
                        'a' => 'Most Electrolux parts arrive through Canadian distributors within 1 to 3 days. Some touch-control panels and specialty components can take longer — we give you a clear timeline and never start work without your approval.',
                ),
                array(
