 ...
 * Description: Renders /samsung-appliance-repair/ page. Brand-specific content, factory-not-authorized disclosure, FAQ schema, locked design system. Why-section matches the homepage/service etalon (full-bleed dark banner, WHY CASPIAN kicker, lead, gold-value stat cards, Service-note box).
 * Version: 1.1
 * Author: Caspian Build
 *
 * v1.1 (content + etalon match):
 *  - HERO H1: dropped "Hamilton" -> "Same-Day Samsung Appliance Repair in 30+ Ontario Cities".
 *  - HERO pills: 4 clean trust pills (dropped "Since 2009 (15+ years)" -> "15+ Years";
 *    dropped the "Independent" pill — disclosure stays in the banner + Service note).
 *  - Intro: de-Hamiltonized ("across the 30+ Ontario cities we serve").
 *  - Appliance grid: removed food emoji (etalon has none).
 *  - WHY section rebuilt to mirror the etalon EXACTLY: full-bleed dark band, left-aligned,
 *    "WHY CASPIAN" kicker, left H2, unique Samsung lead paragraph, 4 stat cards with the
 *    GOLD value on top + light label below, and a gold-left-border "Service note" box.
 *    (Replaces the old centered .cb-trust block.)
 *  - CTA-final: unique heading, no "Hamilton".
 *  - KEPT Samsung-unique content: 5E/4E error codes, Family Hub, RF/WF/NE models, FAQ.
 */
...
add_filter( 'the_content', function( $content ) {
        ...
        <div class="caspian-brand-page">
                ...
                <section class="cb-hero">
                        <h1>Same-Day Samsung Appliance Repair in 30+ Ontario Cities</h1>
                        <p class="subtitle">French door fridges, Family Hub displays, Powerfoam washers, FlexZone freezers. We fix the smart features other shops avoid — local technicians, same-day service, 90-day warranty.</p>
                        ...
                        <div class="cb-inner">
                                ...
                                <div class="cb-appliance-grid">
                                        <div class="cb-appliance-card">
                                                <h3>Refrigerators</h3>
                                                <a href="/refrigerator-repair/">Samsung Fridge Repair &rarr;</a>
                                        </div>
                                        <div class="cb-appliance-card">
                                                <h3>Washing Machines</h3>
                                                <a href="/washing-machine-repair/">Samsung Washer Repair &rarr;</a>
                                        </div>
                                        <div class="cb-appliance-card">
                                                <h3>Dryers</h3>
                                                <a href="/dryer-repair/">Samsung Dryer Repair &rarr;</a>
                                        </div>
                                        <div class="cb-appliance-card">
                                                <h3>Dishwashers</h3>
                                                <a href="/dishwasher-repair/">Samsung Dishwasher Repair &rarr;</a>
                                        </div>
                                        <div class="cb-appliance-card">
                                                <h3>Ovens &amp; Ranges</h3>
                                                <a href="/oven-repair/">Samsung Oven Repair &rarr;</a>
                                        </div>
                                        <div class="cb-appliance-card">
                                                <h3>Cooktops</h3>
                                                <a href="/stove-cooktop-repair/">Samsung Cooktop Repair &rarr;</a>
                                        </div>
                                </div>
                        </div>
                </section>
                ...
                <section class="cb-section" style="background:#fff;">
                        <div class="cb-inner">
                                ...
                                <p class="cb-section-lead">More than 15 years of Samsung repairs gives us pattern recognition. These three problems account for the majority of the Samsung service calls we handle across the 30+ Ontario cities we serve.</p>
                ...
                <section class="cb-why">
                        <div class="cb-why-inner">
                                ...
                                <h2>15+ Years of Samsung Appliance Repair Across Ontario</h2>
                                <p class="cb-why-lead">Headquartered in Hamilton, we service Samsung appliances across 30+ Ontario cities — with local technicians who live and work in your area, so the person fixing your Family Hub fridge or Powerfoam washer is from your part of Ontario, not dispatched hours away. BBB A Accredited. Over 220 verified Google reviews averaging <span class="star">&#9733;</span>4.8. Our 8-person live call centre answers seven days a week from 7am to 11pm, so you reach a real person — never a voicemail — when a Samsung breakdown can't wait.</p>
                                ...
                                <div class="cb-why-note">
                                        <p><strong>Service note:</strong> Caspian is an independent service provider, not affiliated with Samsung Electronics or Samsung Canada, and not factory-authorized for in-warranty work. We specialize in high-quality out-of-warranty Samsung service across Ontario. If your unit is still covered by Samsung's warranty, contact Samsung directly first — we are glad to help once that warranty has expired. Gas Samsung appliances are serviced by certified TSSA-licensed partner technicians.</p>
                                </div>
                        </div>
                </section>
                ...
                <section class="cb-cta-final">
                        <h3>Samsung Appliance Repair in 30+ Ontario Cities</h3>
                        <p>Local technicians, same-day service in most areas, live agents 7AM–11PM, and a 90-day parts &amp; labour warranty on every Samsung repair. Independent service — never inflated repair scopes, never factory-authorized claims.</p>
